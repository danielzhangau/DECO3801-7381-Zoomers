    ...
    async function loadResourcesAndDataAsync() {
      try {
        ...
        await cacheImages([
          ...
          require('../img/hotel_vou.jpg'),
          require('../img/hotel.jpg'),
          require('../img/hotys.png'),
          require('../img/HOYTS-Frankston-Recliner.jpg'),
          require('../img/lvgu.jpg'),
          require('../img/pizza_vou.jpg'),
          require('../img/pizza.jpg'),
          require('../img/qr_bar.png'),
          require('../img/lvgu.jpg'),
          require('../img/small_green.jpg'),
          require('../img/small_green2.jpg'),
          require('../img/statistic-bar.png'),
          require('../img/statistic-line.png'),
